...
<footer class="footer_style_2 footer_blog">
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="footer-logo">
                     <img src="<?=get_template_directory_uri()?>/images/logos/logo.png" alt="logo">
                  </div>
               ...
               <div class="col-md-8">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <p>123 Second Street Fifth Avenue, Manhattan, New York</p>
						<p>
               ...
               <div class="cprt">
                  <p>Designed by <a href="#">ongbong.com</a> All rights reserved.</p>
               </div>
            </div>
         </div>
      </footer>
      ...
      <!-- menu js -->
      <script src="<?=get_template_directory_uri()?>/js/menumaker.js"></script>
      <!-- wow animation -->
